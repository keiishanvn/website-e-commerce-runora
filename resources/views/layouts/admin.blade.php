...
<head>
    ...
    <!-- Meta token CSRF wajib untuk mengamankan operasi AJAX/Fetch jika ada di halaman admin -->
...
<body class="bg-gray-100 flex h-screen overflow-hidden antialiased">
    ...
    <!-- SIDEBAR VERTIKAL (Warna Merah Khas Runora #C81010) -->
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        <main class="flex-grow p-8 overflow-y-auto">
            <!-- Tempat menyuntikkan halaman anak (seperti dashboard.blade.php) -->
            @yield('content')
        </main>
    </div>

    <!-- Tempat script tambahan per halaman jika dibutuhkan -->
    @stack('scripts')
</body>
</html>